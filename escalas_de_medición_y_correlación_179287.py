# -*- coding: utf-8 -*-
"""Escalas de medición y correlación_179287.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1qVvdiwhzbthBvx1HrB0hfpSOsV8fZcgy
...
def regresion(x, y):
  ...
  pendienete = numerator / denominator
  ordenada_al_origen = mean_y - pendienete * mean_x

  correlation_matrix = np.corrcoef(x, y)
  correlation_coefficient = correlation_matrix[0, 1]
  return tuple(np.array([pendienete,ordenada_al_origen,correlation_coefficient]))
...
tupla = regresion_lineal_model_3()
print(tupla)
...
def regresion_lineal_model_s():
  ...
  return regresion(x,y)
tupla = regresion_lineal_model_s()
print(tupla)
...
def regresion_lineal_model_x():
  ...
  return regresion(x,y)
tupla = regresion_lineal_model_x()
print(tupla)
...
def regresion_lineal_model_y():
  ...
  return regresion(x,y)
tupla = regresion_lineal_model_y()
print(tupla)
